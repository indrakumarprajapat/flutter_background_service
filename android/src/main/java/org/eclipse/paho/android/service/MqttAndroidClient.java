...
//	private static final String SERVICE_NAME = "org.eclipse.paho.android.org.eclipse.paho.android.service.MqttService";
	private static final String SERVICE_NAME = "id.flutter.flutter_background_service.BackgroundService";
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (MqttServiceConstants.CONNECT_ACTION.equals(action)) {
			...
			mqttService.traceError(BackgroundService.TAG, "Callback action doesn't exist.");
		}
	...
	private void simpleAction(IMqttToken token, Bundle data) {
		if (token != null) {
			...
			mqttService.traceError(BackgroundService.TAG, "simpleAction : token is null");
		}
	}
